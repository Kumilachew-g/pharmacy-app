          ...
          >
            <div className='flex space-x-8 items-center justify-start'>
              ...
              <p
                className={
                  'text-sm font-medium ' +
                  (props.place === 1 ? 'text-indigo-600 ' : 'text-gray-400')
                }
              >
                Dashboard
              </p>
          ...
          >
            <div className='inline-flex space-x-8 items-center justify-start'>
              ...
              <p
                className={
                  'text-sm font-medium ' +
                  (props.place === 2 ? 'text-indigo-600 ' : 'text-gray-400')
                }
              >
                Products
              </p>
          ...
          >
            <div className='inline-flex space-x-8 items-center justify-start'>
              ...
              <p
                className={
                  'text-sm font-medium ' +
                  (props.place === 3 ? 'text-indigo-600 ' : 'text-gray-400')
                }
              >
                Billing
              </p>
          ...
          >
            <div className='inline-flex space-x-8 items-center justify-start'>
              ...
              <p
                className={
                  'text-sm font-medium ' +
                  (props.place === 4 ? 'text-indigo-600 ' : 'text-gray-400')
                }
              >
                Vendors
              </p>
          ...
          >
            <div className='inline-flex space-x-8 items-center justify-start'>
              ...
              <p
                className={
                  'text-sm font-medium ' +
                  (props.place === 5 ? 'text-indigo-600 ' : 'text-gray-400')
                }
              >
                Delivery
              </p>
